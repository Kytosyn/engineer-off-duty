...
const CONTENT = {
  en: {
    ...
    travel: [
      ...
      { emoji: '🇻🇳', place: 'Vietnam (Ho Chi Minh City)', desc: 'Bustling streets, pho, war history' },
      { emoji: '🇦🇪', place: 'UAE (Abu Dhabi)', desc: 'Modern luxury, desert dunes, Grand Mosque' },
      { emoji: '🇩🇪', place: 'Germany', desc: 'Engineering, beer gardens, castles' },
      { emoji: '🇧🇪', place: 'Belgium', desc: 'Waffles, chocolate, medieval towns' },
      { emoji: '🇳🇱', place: 'Netherlands', desc: 'Canals, tulips, cycling culture' },
      { emoji: '🇲🇴', place: 'Macau', desc: 'Casinos, Portuguese heritage, egg tarts' },
      { emoji: '🇭🇰', place: 'Hong Kong', desc: 'Skyline, dim sum, shopping paradise' },
    ],
    hotels: [
      { name: "Lloyd's KL", location: 'Kuala Lumpur, Malaysia', rating: '⭐⭐⭐⭐', desc: 'Comfortable stay with great city views.' },
      { name: 'Hilton KL', location: 'Kuala Lumpur, Malaysia', rating: '⭐⭐⭐⭐⭐', desc: 'Premium luxury experience in the heart of KL.' },
      { name: 'Hotel Royal Signature', location: 'Kuala Lumpur, Malaysia', rating: '⭐⭐⭐⭐', desc: 'Boutique hotel with excellent service and modern amenities.' },
      { name: 'Shangri-La Bangkok', location: 'Bangkok, Thailand', rating: '⭐⭐⭐⭐⭐', desc: 'Riverside luxury with impeccable service and stunning views.' },
      { name: 'The Standard Bangkok', location: 'Bangkok, Thailand', rating: '⭐⭐⭐⭐⭐', desc: 'Hip, trendy hotel with amazing rooftop bar and design.' },
      { name: 'Lancaster Bangkok', location: 'Bangkok, Thailand', rating: '⭐⭐⭐⭐', desc: 'Elegant stay with great breakfast and friendly staff.' },
    ],
    ...
    offDutyStats: { countries: '15 Countries', projects: '0 Projects', years: '0 Years' },
    hobby: 'Hobby',
    post: 'Post',
    video: 'Video',
  ...
  zh: {
    ...
    travel: [
      ...
      { emoji: '🇻🇳', place: '越南（胡志明市）', desc: '繁华街道、河粉、战争历史' },
      { emoji: '🇦🇪', place: '阿联酋（阿布扎比）', desc: '现代豪华、沙漠沙丘、大清真寺' },
      { emoji: '🇩🇪', place: '德国', desc: '工程、啤酒花园、城堡' },
      { emoji: '🇧🇪', place: '比利时', desc: '华夫饼、巧克力、中世纪小镇' },
      { emoji: '🇳🇱', place: '荷兰', desc: '运河、郁金香、骑行文化' },
      { emoji: '🇲🇴', place: '澳门', desc: '赌场、葡萄牙遗产、蛋挞' },
      { emoji: '🇭🇰', place: '香港', desc: '天际线、点心、购物天堂' },
    ],
    hotels: [
      { name: "Lloyd's KL", location: '吉隆坡, 马来西亚', rating: '⭐⭐⭐⭐', desc: '舒适的住宿，享有绝佳的城市景观。' },
      { name: 'Hilton KL', location: '吉隆坡, 马来西亚', rating: '⭐⭐⭐⭐⭐', desc: '位于吉隆坡市中心的豪华体验。' },
      { name: 'Hotel Royal Signature', location: '吉隆坡, 马来西亚', rating: '⭐⭐⭐⭐', desc: '精品酒店，服务周到，设施现代。' },
      { name: 'Shangri-La Bangkok', location: '曼谷, 泰国', rating: '⭐⭐⭐⭐⭐', desc: '河畔豪华酒店，服务完美，景色迷人。' },
      { name: 'The Standard Bangkok', location: '曼谷, 泰国', rating: '⭐⭐⭐⭐⭐', desc: '时尚潮流酒店，拥有绝佳的天台酒吧和设计。' },
      { name: 'Lancaster Bangkok', location: '曼谷, 泰国', rating: '⭐⭐⭐⭐', desc: '优雅的住宿，早餐美味，员工友好。' },
    ],
    food: '您的美食故事在这里...',
    music: '最喜欢的艺术家',
    musicArtists: ['Jeremy Zucker', 'Joji', 'NewJeans', 'Man With A Mission', 'Jon Bellion', 'Adele'],
    ...
    offDutyStats: { countries: '15 个国家', projects: '0 项目', years: '0 年' },
    hobby: '爱好',
    post: '帖子',
    video: '视频',
